/**
 * Created by JIYANG.JIN on 2020/8/3.
 */
/*!
...
!function (A, e) {
    ...
    var i, U, E, F, h, H = 10, d = 13, f = 15, p = 17, N = 18, m = 19, R = 20, L = 21, v = 22, O = 24, D = 25, b = 26, M = 27, y = 28, _ = 30, P = 32, x = 33, V = 34, z = 35, X = 37, J = 38, G = 39, k = 40, W = 42, Y = "¡Á", q = (i = function (A) {
    ...
    }(U, Math.ceil((24 + U[4]) / 4)), new s(U[0], U[1], U[2], U[3], F, h)), Z = [_, 36], j = [1, 2, 3, 5], $ = [H, 8], AA = [M, b], eA = j.concat($), tA = [J, G, k, V, z], rA = [f, d], nA = (BA.prototype.slice = function () {
    ...
    }, se = {type: sA.NUMBER_TOKEN, number: 0, flags: 4}, oe = {
        type: sA.PERCENTAGE_TOKEN,
        number: 50,
        flags: 4
    ...
    var Lr, vr, Or = {
        ...
        matrix: function (A) {
            ...
            var e = A.filter(function (A) {
                ...
                return A.number
            }), t = e[0], r = e[1], n = (e[2], e[3], e[4]), B = e[5], s = (e[6], e[7], e[8], e[9], e[10], e[11], e[12]), o = e[13];
            e[14], e[15];
    ...
    var _n, Pn = [{type: sA.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3}], xn = [{
        type: sA.PERCENTAGE_TOKEN,
        flags: 0,
        number: 50
    ...
    function rB(A) {
        ...
        try {
            if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
                ...
                var t = A.contentWindow.document.documentElement ? AB(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor) : He.TRANSPARENT, r = A.contentWindow.document.body ? AB(getComputedStyle(A.contentWindow.document.body).backgroundColor) : He.TRANSPARENT;
    ...
    var LB, vB, OB = {
        ...
        switch (e) {
            ...
            case tr.CJK_DECIMAL:
                return mB(A, "©–Ò»¶þÈýËÄÎåÁùÆß°Ë¾Å", n);
            case tr.LOWER_ROMAN:
            ...
            case tr.CJK_EARTHLY_BRANCH:
                return mB(A, "×Ó³óÒúÃ®³½ËÈÎçÎ´ÉêÓÏÐçº¥", n);
            case tr.CJK_HEAVENLY_STEM:
                return mB(A, "¼×ÒÒ±û¶¡Îì¼º¸ýÐÁÈÉ¹ï", n);
            case tr.CJK_IDEOGRAPHIC:
            case tr.TRAD_CHINESE_INFORMAL:
                return RB(A, "ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å", "Ê®°ÙÇ§Èf", "Ø“", n, 14);
            case tr.TRAD_CHINESE_FORMAL:
                return RB(A, "ÁãÒ¼ÙE…¢ËÁÎéê‘Æâ°Æ¾Á", "Ê°°ÛÇªÈf", "Ø“", n, 15);
            case tr.SIMP_CHINESE_INFORMAL:
                return RB(A, "ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å", "Ê®°ÙÇ§Èf", "¸º", n, 14);
            case tr.SIMP_CHINESE_FORMAL:
                return RB(A, "ÁãÒ¼·¡ÈþËÁÎéÂ½Æâ°Æ¾Á", "Ê°°ÛÇªÈf", "¸º", n, 15);
            case tr.JAPANESE_INFORMAL:
                return RB(A, "©–Ò»¶þÈýËÄÎåÁùÆß°Ë¾Å", "Ê®°ÙÇ§Íò", "¥Þ¥¤¥Ê¥¹", n, 0);
            case tr.JAPANESE_FORMAL:
                return RB(A, "Áã‰Òr²ÎËÄÎéÁùÆß°Ë¾Å", "Ê°°ÙÇ§Íò", "¥Þ¥¤¥Ê¥¹", n, 7);
            case tr.KOREAN_HANGUL_FORMAL:
                return RB(A, "??????????", "????", MB, B, 7);
            case tr.KOREAN_HANJA_INFORMAL:
                return RB(A, "ÁãÒ»¶þÈýËÄÎåÁùÆß°Ë¾Å", "Ê®°ÙÇ§Èf", MB, B, 0);
            case tr.KOREAN_HANJA_FORMAL:
                return RB(A, "ÁãÒ¼ÙE…¢ËÄÎåÁùÆß°Ë¾Å", "Ê°°ÙÇ§", MB, B, 7);
            case tr.DEVANAGARI:
            ...
            case tr.HIRAGANA:
                return mB(A, "¤¢¤¤¤¦¤¨¤ª¤«¤­¤¯¤±¤³¤µ¤·¤¹¤»¤½¤¿¤Á¤Ä¤Æ¤È¤Ê¤Ë¤Ì¤Í¤Î¤Ï¤Ò¤Õ¤Ø¤Û¤Þ¤ß¤à¤á¤â¤ä¤æ¤è¤é¤ê¤ë¤ì¤í¤ï¤ð¤ñ¤ò¤ó");
            case tr.HIRAGANA_IROHA:
                return mB(A, "¤¤¤í¤Ï¤Ë¤Û¤Ø¤È¤Á¤ê¤Ì¤ë¤ò¤ï¤«¤è¤¿¤ì¤½¤Ä¤Í¤Ê¤é¤à¤¦¤ð¤Î¤ª¤¯¤ä¤Þ¤±¤Õ¤³¤¨¤Æ¤¢¤µ¤­¤æ¤á¤ß¤·¤ñ¤Ò¤â¤»¤¹");
            case tr.KANNADA:
                return TB(A, 3302, 3311, !0, r);
            case tr.KATAKANA:
                return mB(A, "¥¢¥¤¥¦¥¨¥ª¥«¥­¥¯¥±¥³¥µ¥·¥¹¥»¥½¥¿¥Á¥Ä¥Æ¥È¥Ê¥Ë¥Ì¥Í¥Î¥Ï¥Ò¥Õ¥Ø¥Û¥Þ¥ß¥à¥á¥â¥ä¥æ¥è¥é¥ê¥ë¥ì¥í¥ï¥ð¥ñ¥ò¥ó", n);
            case tr.KATAKANA_IROHA:
                return mB(A, "¥¤¥í¥Ï¥Ë¥Û¥Ø¥È¥Á¥ê¥Ì¥ë¥ò¥ï¥«¥è¥¿¥ì¥½¥Ä¥Í¥Ê¥é¥à¥¦¥ð¥Î¥ª¥¯¥ä¥Þ¥±¥Õ¥³¥¨¥Æ¥¢¥µ¥­¥æ¥á¥ß¥·¥ñ¥Ò¥â¥»¥¹", n);
            case tr.LAO:
        ...
        var n = A.defaultView.pageXOffset, B = A.defaultView.pageYOffset, s = r.contentWindow, o = s.document, i = JB(r).then(function () {
                ...
                GB(e, E), g.content.forEach(function (A) {
                    if (A.type === sA.STRING_TOKEN)E.appendChild(C.createTextNode(A.value)); else if (A.type === sA.URL_TOKEN) {
                        ...
                        if ("attr" === A.name) {
                            ...
                            if (B = i[2], n && zA(n)) {
                                var c = l.counters.getCounterValues(n.value), Q = B && zA(B) ? ir.parse(B.value) : tr.DECIMAL, w = a && a.type === sA.STRING_TOKEN ? a.value : "", u = c.map(function (A) {
                                    return yB(A, Q, !1)
                                }).join(w);
    ...
    var Bs = (ss.prototype.subdivide = function (A, e) {
        var t = ns(this.start, this.startControl, A), r = ns(this.startControl, this.endControl, A), n = ns(this.endControl, this.end, A), B = ns(t, r, A), s = ns(r, n, A), o = ns(B, s, A);
    ...
    var is, as, cs = function (A) {
        var e = A.styles, t = A.bounds, r = jA(e.borderTopLeftRadius, t.width, t.height), n = r[0], B = r[1], s = jA(e.borderTopRightRadius, t.width, t.height), o = s[0], i = s[1], a = jA(e.borderBottomRightRadius, t.width, t.height), c = a[0], Q = a[1], w = jA(e.borderBottomLeftRadius, t.width, t.height), u = w[0], U = w[1], l = [];
        ...
        var g = t.width - o, E = t.height - Q, F = t.width - c, h = t.height - U, H = e.borderTopWidth, d = e.borderRightWidth, f = e.borderBottomWidth, p = e.borderLeftWidth, N = ae(e.paddingTop, A.bounds.width), K = ae(e.paddingRight, A.bounds.width), I = ae(e.paddingBottom, A.bounds.width), T = ae(e.paddingLeft, A.bounds.width);
    ...
    function hs(A) {
        var e = A.styles, t = A.bounds, r = ae(e.paddingLeft, t.width), n = ae(e.paddingRight, t.width), B = ae(e.paddingTop, t.width), s = ae(e.paddingBottom, t.width);
    ...
    function Hs(A, e, t) {
        ...
        }(Ts(A.styles.backgroundClip, e), A), B = Is(Ts(A.styles.backgroundSize, e), t, r), s = B[0], o = B[1], i = jA(Ts(A.styles.backgroundPosition, e), r.width - s, r.height - o);
    ...
    var Os = (Ds.prototype.applyEffects = function (A, e) {
        ...
        }).join(""), t = A.fontFamily.join(", "), r = xA(A.fontSize) ? "" + A.fontSize.number + A.fontSize.unit : A.fontSize.number + "px";
